...
CREATE TABLE api.all_bonds_aims_to_dashboard_staging (
  "aims_dept_prog_act" text,
  "dashboard_deptfundprogact" text,
  "updated_at" timestamp
);

CREATE TABLE api.all_bonds_baseline_spend_staging (
  "dashboard_deptfundprogact" text,
  "date" date,
  "amount" numeric,
  "updated_at" timestamp
...
CREATE TABLE api.all_bonds_spend_plan_staging (
  "dashboard_deptfundprogact" text,
  "fiscal_year" int,
  "amount" numeric,
  "updated_at" timestamp
...
CREATE TABLE api.all_bonds_appropriations_staging (
  "dashboard_deptfundprogact" text,
  "date" date,
  "amount" numeric,
  "updated_at" timestamp
...
CREATE TABLE api.all_bonds_program_names_staging (
  "dashboard_deptfundprogact" text,
  "department_name" text,
  "bond_year" int,
  "program_name" text,
...
CREATE TABLE api.expenses_obligated_all_bonds_raw_staging (
  "fund_code" text,
  "fund_long_name" text,
  "division_code" text,
  "division_long_name" text,
